...
namespace Unity.MARS
{
    ...
    public class MARSNavMeshAgent : MonoBehaviour
    {
        ...
        const float k_ValidStartInterval = 0.5f;
        ...
        float m_ValidStartTimer = 0.0f;

        float m_GraceTimer = 0;
        bool m_BackupMotionEventStarted = false;
        ICustomOutOfBoundsMotion m_BackupMotionProvider = null;

        Vector3 m_DynamicMotionStart;
        Vector3 m_DynamicMotionDestination;
        float m_DynamicMotionTimer = 0.0f;
        float m_DynamicMotionTime = 0.0f;
        ICustomDynamicMotion m_DynamicMotionProvider = null;
        ...
        void SetupDynamicMotion(Vector3 startPosition, Vector3 endPosition)
        {
            ...
            m_DynamicMotionTime = (endPosition - startPosition).magnitude/m_Agent.speed;
            m_DynamicMotionTimer = m_DynamicMotionTime;
            m_CurrentSpeed = m_Agent.speed;
