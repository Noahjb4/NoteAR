    ...
    public class MarsCompareTool : EditorTool
    {
        ...
        void DrawComponentInspectorControls(Condition condition, int selectionIndex = 0)
        {
            ...
            using (new EditorGUILayout.VerticalScope(styles.boxStyle))
            {
                ...
                styles.dataLabelStyle.normal.textColor = !traitPassesCondition ? MARSUserPreferences.instance.conditionFailTextColor : GUI.skin.label.normal.textColor;
        ...
        void DrawCompareControls(Editor editor)
        {
            ...
            using (new EditorGUILayout.HorizontalScope())
            {
                ...
                else
                {
                    ...
                    {
                        EditorTools.SetActiveTool<MarsCompareTool>();
                    }
                }
            }
        }
        ...
        {
            m_ToolIsActive = EditorTools.IsActiveTool(this);
            if (m_CompareDataModule != null)
            {
                if (m_ToolIsActive)
                {
