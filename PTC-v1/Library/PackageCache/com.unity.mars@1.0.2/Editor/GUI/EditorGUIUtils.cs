...
namespace Unity.MARS
{
    ...
    public static class EditorGUIUtils
    {
        ...
        public static bool DrawHeader(string title, SerializedProperty propertyGroup, SerializedProperty activeField,
        ...
        public static bool DrawFoldoutUI(bool expanded, bool showToggle, string title, GUIStyle toggleStyle,
        ...
        public static void PropertyField(SerializedPropertyData toggleProperty, SerializedPropertyData property,
            bool onlyHideToggle = false, bool showHideInInspector = true, Color? overrideColor = null)
        {
            var title = GetContent(property.DisplayName);
        ...
        /// <param name="toggleProperty">Property representing the checkbox value</param>
        /// <param name="property">The property being drawn</param>
        /// <param name="customLabel">The custom label to use for this property</param>
        /// <param name="onlyHideToggle"></param>
        /// <param name="showHideInInspector">Force this property to draw despite a HideInInspector attribute</param>
        public static void PropertyField(SerializedPropertyData toggleProperty, SerializedPropertyData property,
            string customLabel, bool onlyHideToggle = false, bool showHideInInspector = true)
        {
            var content = new GUIContent(customLabel);
        ...
        public static void PropertyField(SerializedPropertyData toggleProperty, SerializedPropertyData property,
            GUIContent title, bool onlyHideToggle = false, bool showHideInInspector = true)
        {
        ...
        public static void PropertyFieldInRect(Rect position, SerializedPropertyData toggleProperty, SerializedPropertyData property,
            bool onlyHideToggle = false, bool showHideInInspector = true)
        {
            var title = GetContent(property.DisplayName);
        ...
        /// <param name="keyWidth">Layout options to be applied to the keys column</param>
        /// <param name="valueWidth">Layout options to be applied to the values column</param>
        public static void DrawDictionary<TKey>(Dictionary<TKey, float> dictionary,
            string keyLabel, string valueLabel,
        ...
        /// <param name="keyWidth">Layout options to be applied to the keys column</param>
        /// <param name="valueWidth">Layout options to be applied to the values column</param>
        public static void DrawDictionaryWithHeader<TKey, TValue>(Dictionary<TKey, TValue> dictionary,
        ...
        public static bool ImageToggle(bool value, GUIContent guiContent, Texture onImage, Texture offImage,
