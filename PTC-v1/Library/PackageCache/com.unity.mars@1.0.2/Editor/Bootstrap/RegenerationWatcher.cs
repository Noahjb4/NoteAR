...
#pragma warning restore 649
        ...
        static void DeleteGeneratedFiles()
        {
            ...
            {
                Debug.Log($"Clearing MARS generated code in {Constants.GeneratedPath}");
            ...
            {
                Debug.LogWarning($"Could not find the MARS generated code folder {Constants.GeneratedPath}!");
            }
            catch (Exception e)
            {
