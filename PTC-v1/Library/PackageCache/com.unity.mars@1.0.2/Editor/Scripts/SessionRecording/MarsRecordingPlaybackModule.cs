...
namespace Unity.MARS.Recording
{
        ...
        IModuleMarsUpdate, IModuleBehaviorCallbacks
    {
        ...
        public void ConnectDependency(MARSSceneModule dependency) { m_MarsSceneModule = dependency; }

        public void ConnectDependency(SimulationRecordingManager dependency) { m_SimulationRecordingManager = dependency; }
        ...
        {
            if (!MARSUtils.SimulatingDiscovery)
                return;
        ...
        {
            var simulationSettings = SimulationSettings.instance;
            if (DisableRecordingPlayback || !simulationSettings.IsUsingRecording || !MARSUtils.SimulatingDiscovery)
            {
                m_CurrentRecordingInfo = null;
                TimelineSyncState = SimulationTimeSyncState.NoTimeline;
                return;
