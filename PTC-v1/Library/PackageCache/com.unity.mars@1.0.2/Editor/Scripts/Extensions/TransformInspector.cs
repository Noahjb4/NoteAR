...
namespace Unity.MARS
{
    ...
    class TransformInspector : Editor
    {
        ...
        public void OnEnable()
        {
            ...
            m_IsMarsScene = session.gameObject.scene == scene || m_Transform.IsChildOf(simSceneModule.ContentRoot.transform);
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                MARSUtils.HintBox(m_IsMarsScene && MarsHints.ShowWorldScaleHint, k_WorldScaleHint,
            ...
            if (m_SettingHideFlags)
            {
                MARSUtils.HintBox(MarsHints.ShowDisabledSimulationComponentsHint, k_DisabledComponentHint,
