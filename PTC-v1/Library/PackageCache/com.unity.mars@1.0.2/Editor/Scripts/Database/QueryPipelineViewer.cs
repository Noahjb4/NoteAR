...
namespace Unity.MARS
{
    public partial class QueryPipelineViewer : EditorWindow
    {
        ...
        public void OnEnable()
        {
            ...
            m_ShowSearchHint = MarsHints.ShowQuerySearchHint;

            var module = ModuleLoaderCore.instance.GetModule<MARSQueryBackend>();
            if (module != null)
                module.onQueryMatchFound += GetValuesAndRepaint;
        ...
        {
            s_QueryBackend = ModuleLoaderCore.instance.GetModule<MARSQueryBackend>();
