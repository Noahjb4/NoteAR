...
namespace Unity.MARS.Build
{
    public abstract class ElectiveExtensions : IPreprocessBuildWithReport
    {
        ...
        public static string RunReport(SupportedConfiguration config)
        {
            ...
            if (MARSUserPreferences.instance.ElectiveExtensionsReportsErrors)
            {
        ...
        static ElectiveReport CheckUnityEditorVersion(SupportedConfiguration config)
        {
            ...
            if (config.SupportedEditorVersions.Any(version => Application.unityVersion.StartsWith(version)))
            {
        ...
        {
            return listVersions.Any(version.StartsWith);
        }
        ...
        {
            public static IEnumerable<PackageInfo> Infos { get { return SearchForInstalledPackageItems(); } }


            static IEnumerable<PackageInfo> SearchForInstalledPackageItems()
            {
