...
#pragma warning restore 0414
        ...
        static readonly GUIContent k_ColorOptionsButtonContent = new GUIContent("...", "Color options");
        ...
        void OnDisable()
        {
            ...
            if (MARSEntityEditorModule.instance != null)
                MARSEntityEditorModule.instance.UpdateConditionData();
        }
        ...
        void DrawColorEditor()
        {
            ...
            using (new EditorGUILayout.HorizontalScope())
            {
                ...
                if (GUILayout.Button(k_ColorOptionsButtonContent, MARSEditorGUI.Styles.MiniFontButton, GUILayout.ExpandWidth(false)))
                {
        ...
        void DrawSelectObjectButtons()
        {
            ...
            if (simObject != null || sceneObject != null)
            {
                using (new EditorGUILayout.HorizontalScope())
                {
                    GUILayout.Label(k_SelectObjectLabel, MARSEditorGUI.Styles.LabelLeftAligned);
        ...
        void DrawEntitySetupWizard()
        {
            ...
            else if ((m_SelectedEntity as ProxyGroup) != null)
            {
                ...
                {
                    MARSUtils.HintBox(true, k_NoRelationWarning, k_NoRelation,
                        k_LearnMoreSetsButton, MARSHelpURLs.MARSSetHelpURL, k_StopShowingEntityHints,
                        () => {
            ...
            {
                MARSUtils.HintBox(true, k_NoConditionsAssignedWarning, k_NoConditions,
                    k_LearnMoreConditionsButton, MARSHelpURLs.MARSConditionsHelpURL, k_StopShowingEntityHints, () =>
                    {
                        MarsHints.ShowEntitySetupHints = false;
                    });
