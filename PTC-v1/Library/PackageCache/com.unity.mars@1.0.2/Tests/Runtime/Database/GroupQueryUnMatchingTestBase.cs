...
{
    public abstract class GroupQueryUnMatchingTestBase : RuntimeQueryTest, IProvidesTraits<Vector2>, IProvidesTraits<Pose>, IProvidesTraits<bool>, IUsesSetQueryResults
    {
