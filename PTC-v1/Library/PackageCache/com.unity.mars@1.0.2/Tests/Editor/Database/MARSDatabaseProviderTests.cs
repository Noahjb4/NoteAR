...
#pragma warning disable 67
    public class MARSDatabaseProviderTests
    {
        ...
        public void AddGetRemove_TraitValue<T>(MARSTraitDataProvider<T> provider, int id, string traitName, T traitValue)
        {
        ...
        public void AddGetRemoveSemanticTagTraitValue()
        {
            ...
            AddGetRemove_TraitValue(tagTraits, k_ExampleTraitId, TraitNames.Floor, true);
        }

        [Test]
        public void AddGetRemoveIntTraitValue()
        {
            m_Db.GetTraitProvider(out MARSTraitDataProvider<int> intTraits);
            AddGetRemove_TraitValue(intTraits, k_ExampleTraitId, "dogs.count", 24);
        }
        ...
        public void AddGetRemoveFloatTraitValue()
        {
            ...
            AddGetRemove_TraitValue(floatTraits, k_ExampleTraitId, "temp.celsius", 20.02f);
        }
        ...
        public void AddGetRemoveVector2TraitValue()
        {
            ...
            AddGetRemove_TraitValue(vector2Traits, k_ExampleTraitId, "myroom.size", Vector2.down);
        }

        [Test]
        public void AddGetRemoveVector3TraitValue()
        {
            m_Db.GetTraitProvider(out MARSTraitDataProvider<Vector2> vector3Traits);
            AddGetRemove_TraitValue(vector3Traits, k_ExampleTraitId, "wind.direction", Vector3.up);
        }

        [Test]
        public void AddGetRemoveStringTraitValue()
        {
            m_Db.GetTraitProvider(out MARSTraitDataProvider<string> stringTraits);
            AddGetRemove_TraitValue(stringTraits, k_ExampleTraitId, "city.name", "San Francisco");
        }
