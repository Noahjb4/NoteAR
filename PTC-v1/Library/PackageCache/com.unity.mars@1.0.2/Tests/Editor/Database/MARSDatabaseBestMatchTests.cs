...
{
    public class MARSDatabaseBestMatchTests
    {
        MARSDatabase m_Db;
        int m_DataID;
            ...
            float minBound, float maxBound)                    // expected boundaries
        {
            ...
            var conditions = Conditions.FromGenericIMRObject(rwo);
        ...
        public void ConditionRatingsData_ConstructsCorrectSizeArray_ForConditionCount()
        {
            ...
            var ratings = new ConditionRatingsData(Conditions.FromGenericIMRObject(m_ConditionsRoot));
