...
{
    public class MARSDatabaseQueryTests
    {
        ...
        public void Setup()
        {
            ...
            m_Conditions = Conditions.FromGenericIMRObject(conditionsRoot);
        ...
        public void DisabledConditionComponentsAreIgnored()
        {
            ...
            var newConditions = Conditions.FromGenericIMRObject(conditionsRoot);
        ...
        Conditions SetupExclusiveSemanticTagTest(int count)
        {
        ...
        static TryBestMatchArguments MatchArgsForConditions(Conditions conditions, Exclusivity exclusivity)
        {
