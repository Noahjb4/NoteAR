...
namespace Unity.MARS.Data
{
    ...
    public partial class MARSDatabase : IModuleMarsUpdate, IUsesCameraOffset, IUsesCameraPose
    {
        ...
        internal void CacheTraitReferences(List<int> indexes, List<int> filteredIndexes, Conditions[] conditions, ref CachedTraitCollection[] references)
        {
        ...
        internal bool FindTraitCollections(Conditions conditions, CachedTraitCollection cache)
        {
            if (cache.fulfilled)
                return true;
        ...
        internal bool DataPassesAllConditions(Conditions conditions, int dataId)
        {
            if (conditions.TryGetType(out ISemanticTagCondition[] semanticTagConditions))
            {
                GetTraitProvider(out MARSTraitDataProvider<bool> tagTraitProvider);
