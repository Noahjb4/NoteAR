...
{
    public class EditorPrefsUtilsTests
    {
        class DummyClass
        {
            public static bool boolTest
            {
                get { return EditorPrefsUtils.GetBool(k_TypeName, k_BoolTestValue); }
                set { EditorPrefsUtils.SetBool(k_TypeName, value); }
            }

            public static float floatTest
            {
                get { return EditorPrefsUtils.GetFloat(k_TypeName, k_FloatTestValue); }
                set { EditorPrefsUtils.SetFloat(k_TypeName, value); }
            }

            public static int intTest
            {
                get { return EditorPrefsUtils.GetInt(k_TypeName, k_IntTestValue); }
                set { EditorPrefsUtils.SetInt(k_TypeName, value); }
            }

            public static string stringTest
            {
                get { return EditorPrefsUtils.GetString(k_TypeName, k_StringTestValue); }
                set { EditorPrefsUtils.SetString(k_TypeName, value); }
            }

            public static DummyEnum enumTest
            {
                get { return (DummyEnum)EditorPrefsUtils.GetInt(k_TypeName, (int)k_EnumTestValue); }
                set { EditorPrefsUtils.SetInt(k_TypeName, (int)value); }
            }

            public static Color colorTest
            {
                get { return EditorPrefsUtils.GetColor(k_TypeName, Color.cyan); }
        ...
        {
            EditorPrefsUtils.RestEditorPrefsValueSessionCache();
