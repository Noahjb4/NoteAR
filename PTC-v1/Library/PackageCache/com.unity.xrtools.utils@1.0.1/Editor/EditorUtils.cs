...
namespace Unity.XRTools.Utils
{
    ...
    public static class EditorUtils
    {
        ...
        /// </summary>
        /// <param name="property">The property from which to get a tooltip</param>
        ...
        /// </summary>
        /// <param name="enabledStates">A mapping of class to and script class name to desired enabled state</param>
